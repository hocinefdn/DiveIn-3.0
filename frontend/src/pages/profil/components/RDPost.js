...
import SuppRDPost from './SuppRDPost'

const { Meta } = Card

function RDPost({ post, RedivePost, setRedivePost, socket, lastMessage }) {
    ...
    const [contenu, setContenu] = useState('') // pour separer le lien video de texte
    ...
    const READ_Video = () => {
        if (post.RTcontent) {
            let findLink = post.RTcontent.split(' ')
            ...
            >
                {isLoading ? (
                    ...
                    ' '
                                        ...
                                        {video ? (
                                            <>
                                                ...
                                                {isVideoLoading ? (
                                                    ...
                                                    <iframe
                                                        className="h-96 w-full rounded-lg p-1"
                                                        src={video}
                                                        title={video}
                                                        frameBorder="0"
                                        ...
                                        {/* """""""""""""""""""""""""""""""""""""""""""""""""  PARTIE IMAGES""""""""""""""""""""""" */}
                                        {post.RTimage_post ? (
                                            <div className="rounded-xl  mt-1 mb-1 h-full w-full ">
                                                <img
                                                    src={post.RTimage_post}
                                                    alt="image post"
                                                    className="mr-auto ml-auto w-11/12 rounded-md "
                                                />
                                            </div>
                                        ) : (
                                            ' '
                                        ...
                                        {/* {video ? (
                    <iframe
                        className="h-64 w-full rounded-lg pr-1 pb-1"
                        src={video}
                        title={video}
                        frameBorder="0"
                        allow="accelerometer; autoplay;
    ...
    picture-in-picture"
                    ...
                    ' '
                            ...
                            {/* """"""""""""""""""  PARTIE IMAGES""""""""""""""""""""""" */}
                            {post.image_post ? (
                                <div className="rounded-md mt-1 h-full w-full ">
                                    <img
                                        src={post.image_post}
                                        alt="image post"
                                        className="mr-auto ml-auto w-11/12 rounded-md "
